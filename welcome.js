...
export class Welcome extends Phaser.Scene {
    ...
    constructor() {
        super({
            key: 'Welcome',
            backgroundColor: '#0000', // Configuração da cor de fundo da cena
        });
    }
    ...
    create() {
        ...
        var inputSize = { width: 270, height: 50, padding: 15 };
        ...
        this.inputName = this.add.dom(80, 150).createFromCache('form');
        ...
        this.playBt.on('pointerdown', function () {
            if (this.nameFilled) {
                ...
                this.scene.start('Principal', this.game);
            }
        }, this);
    }
